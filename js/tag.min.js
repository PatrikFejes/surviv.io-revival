...
aiptag.settings = {
	sVersion: '2.0',
	sUpdated: 'Thursday 06 January 2022 - 12:22',
	sPubName: 'SRV',
	sSellerId: 'SRV',
	sPubUrl: 'surviv.io',
	...
	sNetworkIdRewarded: '421469808,1019038',
	...
	iMCMiD: '1019038',
	iAmazonAds: true,
	sNetworkIdVideo: '421469808,1019038',
	sNetworkIdDisplay: '421469808,1019038',
	iAdFading: true,
	iDFPAdSlots: true,
...
bids: [
	...
	},
	{
...
};this.videoAdUnitMaxDuration["surviv.io_preroll"] = "30000";	}
		...
		this.adSlots['surviv-io_728x90'] = {adunit: 'surviv.io_728x90', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_728x90'] = [{slotID: 'surviv-io_728x90', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_728x90', sizes: [[728, 90]]}];
		}
		...
		this.adSlots['surviv-io_300x250'] = {adunit: 'surviv.io_300x250', sizes: [300, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_300x250'] = [{slotID: 'surviv-io_300x250', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_300x250', sizes: [[300, 250]]}];
		}
		...
		this.adSlots['surviv-io_300x250_2'] = {adunit: 'surviv.io_300x250_2', sizes: [300, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_300x250_2'] = [{slotID: 'surviv-io_300x250_2', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_300x250_2', sizes: [[300, 250]]}];
		}
		...
		this.adSlots['surviv-io_300x250_3'] = {adunit: 'surviv.io_300x250_3', sizes: [300, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_300x250_3'] = [{slotID: 'surviv-io_300x250_3', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_300x250_3', sizes: [[300, 250]]}];
		}
		...
		this.adSlots['surviv-io_300x250_4'] = {adunit: 'surviv.io_300x250_4', sizes: [300, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_300x250_4'] = [{slotID: 'surviv-io_300x250_4', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_300x250_4', sizes: [[300, 250]]}];
		}
		...
		this.adSlots['surviv-io_300x250_mobile'] = {adunit: 'surviv.io_300x250_mobile', sizes: [300, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_300x250_mobile'] = [{slotID: 'surviv-io_300x250_mobile', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_300x250_mobile', sizes: [[300, 250]]}];
		}
		...
		this.adSlots['surviv-io_300x250_mobile_2'] = {adunit: 'surviv.io_300x250_mobile_2', sizes: [300, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_300x250_mobile_2'] = [{slotID: 'surviv-io_300x250_mobile_2', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_300x250_mobile_2', sizes: [[300, 250]]}];
		}
		...
		this.adSlots['surviv-io_300x250_leaderboard'] = {adunit: 'surviv.io_300x250_leaderboard', sizes: [300, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_300x250_leaderboard'] = [{slotID: 'surviv-io_300x250_leaderboard', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_300x250_leaderboard', sizes: [[300, 250]]}];
		}
		...
		this.adSlots['surviv-io_300x250_playerprofile'] = {adunit: 'surviv.io_300x250_playerprofile', sizes: [300, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_300x250_playerprofile'] = [{slotID: 'surviv-io_300x250_playerprofile', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_300x250_playerprofile', sizes: [[300, 250]]}];
		}
		...
		this.adSlots['surviv-io_728x90_Leaderboard'] = {adunit: 'surviv.io_728x90_Leaderboard', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_728x90_Leaderboard'] = [{slotID: 'surviv-io_728x90_Leaderboard', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_728x90_Leaderboard', sizes: [[728, 90]]}];
		}
		...
		this.adSlots['surviv-io_728x90_playerprofile'] = {adunit: 'surviv.io_728x90_playerprofile', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_728x90_playerprofile'] = [{slotID: 'surviv-io_728x90_playerprofile', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_728x90_playerprofile', sizes: [[728, 90]]}];
		}
		...
		this.adSlots['surviv-io_300x250_webview'] = {adunit: 'surviv.io_300x250_webview', sizes: [300, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_300x250_webview'] = [{slotID: 'surviv-io_300x250_webview', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_300x250_webview', sizes: [[300, 250]]}];
		}
		...
		this.adSlots['surviv-io_300x250_webview_2'] = {adunit: 'surviv.io_300x250_webview_2', sizes: [300, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_300x250_webview_2'] = [{slotID: 'surviv-io_300x250_webview_2', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_300x250_webview_2', sizes: [[300, 250]]}];
		}
		...
		this.adSlots['surviv-io_728x90_webview'] = {adunit: 'surviv.io_728x90_webview', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_728x90_webview'] = [{slotID: 'surviv-io_728x90_webview', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_728x90_webview', sizes: [[728, 90]]}];
		}
		...
		this.adSlots['surviv-io_300x600'] = {adunit: 'surviv.io_300x600', sizes: [300, 600], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false};
		if(aiptag.settings.iAmazonAds) {
			this.adUnitsAps['surviv-io_300x600'] = [{slotID: 'surviv-io_300x600', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/surviv.io_300x600', sizes: [[300, 600]]}];
		}
	...
	*/
	...
	if(aRemoveBidders.length > 0) {
		//removeBidders from display
					this.removeBidders(this.adUnits['surviv-io_728x90'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_300x250'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_300x250_2'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_300x250_3'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_300x250_4'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_300x250_mobile'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_300x250_mobile_2'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_300x250_leaderboard'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_300x250_playerprofile'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_728x90_Leaderboard'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_728x90_playerprofile'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_300x250_webview'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_300x250_webview_2'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_728x90_webview'], aRemoveBidders);
					this.removeBidders(this.adUnits['surviv-io_300x600'], aRemoveBidders);
		
		//removeBidders from preroll
						this.removeBidders([this.videoAdUnit["surviv.io_preroll"]], aRemoveBidders);
					}
}
...
aipAPI.prototype.cutomSizeConfig = function() {
		...
		if (window.matchMedia("(min-width: 1500px) and (min-height: 950px)").matches) {
			...
			aipAPItag.addBidder('surviv-io_728x90',{bidder: 'ix',	params: { siteId: '254671', size: [970, 90] }});
			aipAPItag.addBidder('surviv-io_728x90',{bidder: 'ix',	params: { siteId: '254671', size: [970, 250] }});
			aipAPItag.addBidder('surviv-io_728x90',{bidder: 'ix',	params: { siteId: '254671', size: [300, 250] }});
		...
		if (window.matchMedia("(min-width: 750px) and (max-width: 830px)").matches) {
			...
			aipAPItag.addBidder('surviv-io_300x250_2',{bidder: 'ix',	params: { siteId: '254832', size: [728, 90] }});
			...
			aipAPItag.addBidder('surviv-io_300x250_mobile_2',{bidder: 'ix',	params: { siteId: '321921', size: [728, 90] }});
		...
		if (window.matchMedia("(min-width: 830px)").matches) {
			...
			aipAPItag.addBidder('surviv-io_300x250_2',{bidder: 'ix',	params: { siteId: '254832', size: [970, 250] }});
			aipAPItag.addBidder('surviv-io_300x250_2',{bidder: 'ix',	params: { siteId: '254832', size: [970, 90] }});
			aipAPItag.addBidder('surviv-io_300x250_2',{bidder: 'ix',	params: { siteId: '254832', size: [728, 90] }});
			aipAPItag.addBidder('surviv-io_300x250_2',{bidder: 'cpmstar',	params: { placementId: '81289' }});
			...
			aipAPItag.addBidder('surviv-io_300x250_mobile_2',{bidder: 'ix',	params: { siteId: '321921', size: [970, 250] }});
			aipAPItag.addBidder('surviv-io_300x250_mobile_2',{bidder: 'ix',	params: { siteId: '321921', size: [970, 90] }});
			aipAPItag.addBidder('surviv-io_300x250_mobile_2',{bidder: 'ix',	params: { siteId: '321921', size: [728, 90] }});
		...
		if(!this.inIframe()) {
			if(window.location.hostname == 'surviv.io') {
				aipAPItag.addBidder('surviv-io_300x250_2',{bidder: 'rubicon',	params: { accountId: '15636', siteId: '251260', zoneId: '1245602' }});
				aipAPItag.addBidder('surviv-io_300x250',{bidder: 'rubicon',	params: { accountId: '15636', siteId: '251260', zoneId: '1245610' }});
				aipAPItag.addBidder('surviv-io_728x90',{bidder: 'rubicon',	params: { accountId: '15636', siteId: '251260', zoneId: '1245608' }});
			}
		}
...
aipAPI.prototype.initGPT=function(){if(aiptag.settings.iDFPAdSlots||aiptag.settings.sRewardedAdUnitVideo||aiptag.settings.sAdUnitInterstitial)googletag.cmd.push(function(){googletag.pubads().disableInitialLoad()}),aipAPItag.gptLoaded||(function(){var a=document.createElement("script");a.async=!0;a.type="text/javascript";a.src=aiptag.settings.iLimitedAds?"https://web.archive.org/web/20220316104748/https://pagead2.googlesyndication.com/tag/js/gpt.js":"https://web.archive.org/web/20220316104748/https://securepubads.g.doubleclick.net/tag/js/gpt.js";var c=document.getElementsByTagName("script")[0];
...
function b(){aip_pbjs.setConfig({consentManagement:{gdpr:{cmpApi:"iab",timeout:8E3,allowAuctionWithoutConsent:!0,defaultGdprScope:!0}}});aipAPItag.CMPloadTimeout=setTimeout(function(){aipAPItag.log("AIP Ads started after CMP timeout");aipAPItag.start()},aipAPItag.timeout_cmp);var f=document.createElement("link");f.type="text/css";f.rel="stylesheet";f.async=!0;f.href="https://web.archive.org/web/20220316104748/https://cdn.consentmanager.mgr.consensu.org/delivery/cmp.min.css";document.getElementsByTagName("head")[0].appendChild(f);window.cmp_id=
"bottom"===aiptag.cmp.position?15920:13566;window.gdprAppliesGlobally=!1;window.cmp_target="_blank";window.cmp_stayiniframe=1;window.cmp_host="consentmanager.mgr.consensu.org";window.cmp_logoclick="https://web.archive.org/web/20220316104748/https://adinplay.com/?utm_source=publishers&utm_medium=cmp";window.cmp_cdn="cdn.consentmanager.mgr.consensu.org";(function(){var g="",p="_en";"cmp_getlang"in window&&(g=window.cmp_getlang().toLowerCase(),p="_"+g);var m=document.createElement("script");m.src="https://"+window.cmp_host+"/delivery/cmp.php?id="+
...
aipAPItag.log("slotRenderEnded: "+a.slot.getSlotElementId());aipAPItag.log(a)}catch(b){aipAPItag.logError(b)}})})),aiptag.settings.sAdUnitVideo||aiptag.settings.sRewardedAdUnitVideo)&&(aiptag.settings.sRewardedAdUnitVideo&&!aiptag.settings.sAdUnitVideo?aipAPItag.initPlayerTag():aipAPItag.sdkLoaded()?aipAPItag.initPlayerTag():aipAPItag.getScript("//web.archive.org/web/20220316104748/https://imasdk.googleapis.com/js/sdkloader/ima3.js",function(){aipAPItag.initPlayerTag();aipAPItag.sdkLoaded()||(aipAPItag.sdkBlocked=!0)}))};
function aipDisplay(){}
...
source+"'><div style='width:"+d.getWidth()+"px;height:"+d.getHeight()+'px; background-image: url("//web.archive.org/web/20220316104748/https://api.adinplay.com/libs/aiptag/fallback/'+c[fallbackSize][index][0]+"\")'></div></a>")});b&&(document.getElementById(a).innerHTML=b,aipAPItag.log("AD BLOCKED: "+a))}catch(d){aipAPItag.logError(d)}};aipDisplay.prototype.wrapFunction=function(a,c,b){return function(){a.apply(c,b)}};
...
return b*aipAPItag.prerollBidCpm.rhythmone}}};aipAPItag.debug&&aip_pbjs.setConfig({debug:!0});aipAPItag.inIframe()&&aip_pbjs.setConfig({pageUrl:window.location.protocol+"//"+window.location.host});aip_pbjs.setConfig({userSync:{iframeEnabled:!0,useBidCache:!0,syncsPerBidder:1E3,filterSettings:{all:{bidders:"*",filter:"include"}},syncDelay:100},cache:{url:"https://web.archive.org/web/20220316104748/https://prebid.adnxs.com/pbc/v1/cache"},bidderTimeout:aipAPItag.timeout_bid_player,enableSendAllBids:!1,bidderSequence:"random",priceGranularity:{buckets:[{precision:2,
...
aipPlayer.prototype.startPreRoll=function(a){if(aiptag.settings.iForceRewardedAd&&aipAPItag.isMobile()&&!a)this.startRewardedAd(),aipAPItag.log("startRewardedAd");else{this.aipConfig.AD_UNIT_PREROLL=aiptag.settings.sAdUnitVideo;a&&(this.aipConfig.AD_UNIT_PREROLL=a);a=(new Date).getTime();var c=encodeURIComponent(window.location.href).replace(/'/g,"%27").replace(/"/g,"%22"),b=encodeURIComponent(this.aipConfig.DESCRIPTION_URL).replace(/'/g,"%27").replace(/"/g,"%22");this.aipConfig.AD_TAG="https://web.archive.org/web/20220316104748/https://pubads.g.doubleclick.net/gampad/ads?sz=960x540&iu=/"+
...
"absolute",b.style.top="0",b.style.left="0",b.style.bottom="0",b.style.right="0",b.style.zIndex="999997",b.style.width="100%",b.style.height="100%",b.style.backgroundColor="#000000",b.innerHTML='<img border="0" style="position: absolute;z-index: 999998;top: 50%;left: 50%;transform: translate(-50%, -50%);" src="//web.archive.org/web/20220316104748/https://api.adinplay.com/libs/aiptag/assets/loader-red.gif" />',this.aipConfig.PREROLL_ELEM.appendChild(b);else{b=document.getElementById("divFullscreenLoading");"undefined"!=typeof b&&null!=b&&(b=
...
/*
     FILE ARCHIVED ON 10:47:48 Mar 16, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:01:08 Oct 15, 2023.
...
/*
playback timings (ms):
  captures_list: 86.523
  exclusion.robots: 0.122
  exclusion.robots.policy: 0.109
  cdx.remote: 0.072
  esindex: 0.012
  LoadShardBlock: 50.081 (3)
  PetaboxLoader3.datanode: 50.695 (4)
  load_resource: 73.335
  PetaboxLoader3.resolve: 26.007
*/